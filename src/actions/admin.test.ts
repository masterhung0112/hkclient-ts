...
describe('Actions.Admin', () => {
  ...
  it('updateConfig', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/terms_of_service').reply(201, {
      create_at: 1537976679426,
      id: '1234',
      text: 'Terms of Service',
      user_id: '1',
  ...
  it('reloadConfig', async () => {
    nock(Client4.getBaseRoute()).post('/config/reload').reply(200, OK_RESPONSE)
  ...
  it('testEmail', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/email/test').reply(200, OK_RESPONSE)
  ...
  it('testSiteURL', async () => {
    nock(Client4.getBaseRoute()).post('/site_url/test').reply(200, OK_RESPONSE)
  ...
  it('testS3Connection', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/file/s3_test').reply(200, OK_RESPONSE)
  ...
  it('invalidateCaches', async () => {
    nock(Client4.getBaseRoute()).post('/caches/invalidate').reply(200, OK_RESPONSE)
  ...
  it('recycleDatabase', async () => {
    nock(Client4.getBaseRoute()).post('/database/recycle').reply(200, OK_RESPONSE)
  ...
  it('getComplianceReport', async () => {
    ...
    nock(Client4.getBaseRoute()).get(`/compliance/reports/${report.id}`).reply(200, report)
  ...
  it('getComplianceReports', async () => {
    ...
    nock(Client4.getBaseRoute()).get('/compliance/reports').query(true).reply(200, [report])
  ...
  it('uploadBrandImage', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/brand/image').reply(200, OK_RESPONSE)
  ...
  it('deleteBrandImage', async () => {
    nock(Client4.getBaseRoute()).delete('/brand/image').reply(200, OK_RESPONSE)
  ...
  it('getSamlCertificateStatus', async () => {
    nock(Client4.getBaseRoute()).get('/saml/certificate/status').reply(200, {
  ...
  it('uploadPublicSamlCertificate', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/saml/certificate/public').reply(200, OK_RESPONSE)
  ...
  it('uploadPrivateSamlCertificate', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/saml/certificate/private').reply(200, OK_RESPONSE)
  ...
  it('removePublicSamlCertificate', async () => {
    nock(Client4.getBaseRoute()).delete('/saml/certificate/public').reply(200, OK_RESPONSE)
  ...
  it('removePrivateSamlCertificate', async () => {
    nock(Client4.getBaseRoute()).delete('/saml/certificate/private').reply(200, OK_RESPONSE)
  ...
  it('removeIdpSamlCertificate', async () => {
    nock(Client4.getBaseRoute()).delete('/saml/certificate/idp').reply(200, OK_RESPONSE)
  ...
  it('uploadPublicLdapCertificate', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/ldap/certificate/public').reply(200, OK_RESPONSE)
  ...
  it('uploadPrivateLdapCertificate', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/ldap/certificate/private').reply(200, OK_RESPONSE)
  ...
  it('removePublicLdapCertificate', async () => {
    nock(Client4.getBaseRoute()).delete('/ldap/certificate/public').reply(200, OK_RESPONSE)
  ...
  it('removePrivateLdapCertificate', async () => {
    nock(Client4.getBaseRoute()).delete('/ldap/certificate/private').reply(200, OK_RESPONSE)
  ...
  it('testElasticsearch', async () => {
    nock(Client4.getBaseRoute()).post('/elasticsearch/test').reply(200, OK_RESPONSE)

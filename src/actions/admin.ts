...
export function linkLdapGroup(key: string): ActionFunc {
  return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
    ...
    try {
      ...
      dispatch(batchActions([{ type: AdminTypes.LINK_LDAP_GROUP_FAILURE, error, data: key }, logError(error)]))
      return { error }
    }
...
export function unlinkLdapGroup(key: string): ActionFunc {
  return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
    ...
    try {
      ...
      forceLogoutIfNecessary(error, dispatch, getState)
      dispatch(batchActions([{ type: AdminTypes.UNLINK_LDAP_GROUP_FAILURE, error, data: key }, logError(error)]))
      return { error }
    }
...
export function getAnalytics(name: string, teamId = ''): ActionFunc {
  return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
    ...
    try {
      ...
      forceLogoutIfNecessary(error, dispatch, getState)
      dispatch(batchActions([{ type: AdminTypes.GET_ANALYTICS_FAILURE, error }, logError(error)]))
      return { error }
    }
...
export function uploadPlugin(fileData: File, force = false): ActionFunc {
  return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
    ...
    try {
      ...
      forceLogoutIfNecessary(error, dispatch, getState)
      dispatch(batchActions([{ type: AdminTypes.UPLOAD_PLUGIN_FAILURE, error }, logError(error)]))
      return { error }
    }

    dispatch(batchActions([{ type: AdminTypes.UPLOAD_PLUGIN_SUCCESS, data: null }]))
...
export function installPluginFromUrl(url: string, force = false): ActionFunc {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      forceLogoutIfNecessary(error, dispatch, getState)
      dispatch(batchActions([{ type: AdminTypes.INSTALL_PLUGIN_FROM_URL_FAILURE, error }, logError(error)]))
      return { error }
    }
...
export function removePlugin(pluginId: string): ActionFunc {
  return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
    ...
    try {
      ...
      forceLogoutIfNecessary(error, dispatch, getState)
      dispatch(batchActions([{ type: AdminTypes.REMOVE_PLUGIN_FAILURE, error, data: pluginId }, logError(error)]))
      return { error }
    }
...
export function enablePlugin(pluginId: string): ActionFunc {
  return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
    ...
    try {
      ...
      forceLogoutIfNecessary(error, dispatch, getState)
      dispatch(batchActions([{ type: AdminTypes.ENABLE_PLUGIN_FAILURE, error, data: pluginId }, logError(error)]))
      return { error }
    }
...
export function disablePlugin(pluginId: string): ActionFunc {
  return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
    ...
    try {
      ...
      forceLogoutIfNecessary(error, dispatch, getState)
      dispatch(batchActions([{ type: AdminTypes.DISABLE_PLUGIN_FAILURE, error, data: pluginId }, logError(error)]))
      return { error }
    }
...
export function getDataRetentionCustomPolicies(page = 0, perPage = 10): ActionFunc {
  return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
    ...
    dispatch({ type: AdminTypes.RECEIVED_DATA_RETENTION_CUSTOM_POLICIES, data })
...
export function getDataRetentionCustomPolicy(id: string): ActionFunc {
  return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
    ...
    dispatch({ type: AdminTypes.RECEIVED_DATA_RETENTION_CUSTOM_POLICY, data })
...
export function getDataRetentionCustomPolicyTeams(
  ...
  return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
    ...
    dispatch({ type: AdminTypes.RECEIVED_DATA_RETENTION_CUSTOM_POLICY_TEAMS, data })
...
export function getDataRetentionCustomPolicyChannels(
  ...
  return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
    ...
    dispatch({ type: AdminTypes.RECEIVED_DATA_RETENTION_CUSTOM_POLICY_CHANNELS, data })
...
export function searchDataRetentionCustomPolicyTeams(id: string, term: string, opts: TeamSearchOpts): ActionFunc {
  return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
    ...
    dispatch({ type: AdminTypes.RECEIVED_DATA_RETENTION_CUSTOM_POLICY_TEAMS_SEARCH, data })
...
export function searchDataRetentionCustomPolicyChannels(id: string, term: string, opts: ChannelSearchOpts): ActionFunc {
  return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
    ...
    dispatch({ type: AdminTypes.RECEIVED_DATA_RETENTION_CUSTOM_POLICY_CHANNELS_SEARCH, data })
...
export function removeDataRetentionCustomPolicyTeams(
  id: string,
  policy: PatchDataRetentionCustomPolicyTeams
): ActionFunc {
  return bindClientFunc({

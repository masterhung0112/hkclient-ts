                ...
                channelCategories: {
                    byId: {
                        dmCategory1: {
                            ...
                            channel_ids: ['dmChannel1', 'dmChannel2'],
                        },
                        dmCategory2: {
                            id: 'dmCategory2',
                            team_id: 'team2',
                        ...
                        channelsCategory1: {
                            ...
                            channel_ids: ['publicChannel1', 'privateChannel1'],
                        },
                    },
                },
            },
                ...
                channelCategories: {
                    byId: {
                        ...
                        channelsCategory2: {
                            ...
                            team_id: 'team2',
                            type: CategoryTypes.CHANNELS,
                            channel_ids: ['publicChannel2', 'privateChannel2'],
                        },
                    },
                    orderByTeam: {
                ...
                channelCategories: {
                    byId: {
                        ...
                        channelsCategory1: {
                            ...
                            channel_ids: ['publicChannel1', 'gmChannel'],
                        },
                    },
                },
            },
...
describe('moveChannelToCategory', () => {
    ...
    test('should add the channel to the given category at the correct index', async () => {
        ...
        expect(state.entities.channelCategories.byId.category1.channel_ids).toEqual([
            'channel1',
            'channel5',
            'channel6',
            'channel2',
        ...
        test('if the category was sorted by default, should set the destination category to manual sorting', async () => {
            ...
            nock(Client4.getBaseRoute()).
                put(`/users/${currentUserId}/teams/${teamId}/channels/categories`, (body) => {
                    return (
                        body.find((category) => category.id === 'category1').sorting !== CategorySorting.Manual &&
...
describe('moveChannelsToCategory', () => {
    ...
    test('should add channels to the given category at the correct index', async () => {
        ...
        nock(Client4.getBaseRoute()).
            put(`/users/${currentUserId}/teams/${teamId}/channels/categories`).
            reply(200, [
                {...category1, channel_ids: ['channel1', 'channel5', 'channel6', 'channel7', 'channel8', 'channel2']},
            ]);
    ...
    test('should remove the channels from their previous category', async () => {
        ...
        expect(state.entities.channelCategories.byId.category1.channel_ids).toEqual(['channel2']);
        expect(state.entities.channelCategories.byId.category2.channel_ids).toEqual([
            'channel4',
            'channel5',
            'channel6',
            'channel1',

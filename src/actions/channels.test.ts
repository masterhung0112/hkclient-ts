...
describe('Actions.Channels', () => {
  ...
  it('createChannel', async () => {
    nock(Client4.getBaseRoute()).post('/channels').reply(201, TestHelper.fakeChannelWithId(TestHelper.basicTeam.id))

    await store.dispatch(
      Actions.createChannel(TestHelper.fakeChannel(TestHelper.basicTeam.id), TestHelper.basicUser.id)
    )
  ...
  it('createDirectChannel', async () => {
    nock(Client4.getBaseRoute()).post('/users').query(true).reply(201, TestHelper.fakeUserWithId())
  ...
  it('createGroupChannel', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/users/ids').reply(200, [user, user2])
  ...
  it('updateChannel', async () => {
    ...
    nock(Client4.getBaseRoute()).put(`/channels/${channel.id}`).reply(200, channel)
  ...
  it('patchChannel', async () => {
    ...
    await store.dispatch(Actions.patchChannel(TestHelper.basicChannel.id, channel as any))
  ...
  it('getChannel', async () => {
    nock(Client4.getBaseRoute()).get(`/channels/${TestHelper.basicChannel.id}`).reply(200, TestHelper.basicChannel)
  ...
  it('fetchMyChannelsAndMembers', async () => {
    ...
    nock(Client4.getBaseRoute())
      ...
      .reply(200, [
        { user_id: TestHelper.basicUser.id, roles: 'channel_user', channel_id: directChannel.id },
        TestHelper.basicChannelMember,
      ])
  ...
  it('updateChannelNotifyProps', async () => {
    ...
    await store.dispatch(
      Actions.updateChannelNotifyProps(TestHelper.basicUser.id, TestHelper.basicChannel.id, notifyProps)
    )
  ...
  it('deleteChannel', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/users/login').reply(200, user)
    await secondClient.login(user.email, 'password1')

    nock(Client4.getBaseRoute()).post('/channels').reply(201, TestHelper.fakeChannelWithId(TestHelper.basicTeam.id))
    const secondChannel = await secondClient.createChannel(TestHelper.fakeChannel(TestHelper.basicTeam.id))
    ...
    await store.dispatch(Actions.joinChannel(TestHelper.basicUser.id, TestHelper.basicTeam.id, secondChannel.id))
    ...
    nock(Client4.getBaseRoute())
      .get(`/users/me/teams/${TestHelper.basicTeam.id}/channels/members`)
      .reply(200, [
        { user_id: TestHelper.basicUser.id, roles: 'channel_user', channel_id: secondChannel.id },
        TestHelper.basicChannelMember,
      ])

    await store.dispatch(Actions.fetchMyChannelsAndMembers(TestHelper.basicTeam.id))

    nock(Client4.getBaseRoute()).post('/hooks/incoming').reply(201, {
    ...
    const incomingHook = await store.dispatch(
      createIncomingHook({ channel_id: secondChannel.id, display_name: 'test', description: 'test' } as any)
    )
    ...
    const outgoingHook = await store.dispatch(
      createOutgoingHook({
        channel_id: secondChannel.id,
        team_id: TestHelper.basicTeam.id,
        display_name: 'TestOutgoingHook',
    ...
    nock(Client4.getBaseRoute()).delete(`/channels/${secondChannel.id}`).reply(200, OK_RESPONSE)
  ...
  it('markChannelAsViewed', async () => {
    ...
    const userChannel = await Client4.createChannel(TestHelper.fakeChannel(TestHelper.basicTeam.id))
    ...
    nock(Client4.getBaseRoute())
      .get(`/users/me/teams/${TestHelper.basicTeam.id}/channels/members`)
      .reply(200, [
        { user_id: TestHelper.basicUser.id, roles: 'channel_user', channel_id: userChannel.id },
        TestHelper.basicChannelMember,
      ])
  ...
  describe('markChannelAsRead', () => {
    it('one read channel', async () => {
      ...
      assert.equal(state.entities.channels.myMembers[channelId].mention_count, 0)
      assert.equal(
        state.entities.channels.myMembers[channelId].msg_count,
        state.entities.channels.channels[channelId].total_msg_count
      )
    ...
    it('two unread channels, same team, reading one', async () => {
      ...
      assert.equal(
        state.entities.channels.myMembers[channelId1].msg_count,
        state.entities.channels.channels[channelId1].total_msg_count
      )
    ...
    it('two unread channels, same team, reading both', async () => {
      ...
      assert.equal(
        state.entities.channels.myMembers[channelId2].msg_count,
        state.entities.channels.channels[channelId2].total_msg_count
      )
  ...
  it('getChannels', async () => {
    ...
    const userChannel = await userClient.createChannel(TestHelper.fakeChannel(TestHelper.basicTeam.id))
  ...
  it('getAllChannels', async () => {
    ...
    nock(Client4.getBaseRoute()).get('/channels').query(true).reply(200, [TestHelper.basicChannel, userChannel])
  ...
  it('searchAllChannels', async () => {
    ...
    let response = await store.dispatch(
      Actions.searchAllChannels('test', { exclude_default_channels: false, page: 0, per_page: 100 })
    )
    ...
    response = await store.dispatch(
      Actions.searchAllChannels('test', {
        exclude_default_channels: false,
        page: 0,
        per_page: 100,
  ...
  it('updateChannelMemberRoles', async () => {
    nock(Client4.getBaseRoute()).post('/users').reply(201, TestHelper.fakeUserWithId())
  ...
  describe('leaveChannel', () => {
    ...
    test('should delete the channel member when leaving a public channel', async () => {
      ...
      nock(Client4.getBaseRoute()).delete(`/channels/${channel.id}/members/${user.id}`).reply(200, OK_RESPONSE)
    ...
    test('should restore a channel when failing to leave it (non-custom category)', async () => {
      ...
      nock(Client4.getBaseRoute()).delete(`/channels/${channel.id}/members/${user.id}`).reply(500, {})
  ...
  test('joinChannel', async () => {
    ...
    nock(Client4.getBaseRoute()).get(`/channels/${channel.id}`).reply(200, channel)
  ...
  test('favoriteChannel with old sidebar enabled', async () => {
    ...
    nock(Client4.getBaseRoute()).put(`/users/${currentUserId}/preferences`).reply(200, OK_RESPONSE)
  ...
  test('unfavoriteChannel with old sidebar', async () => {
    ...
    nock(Client4.getBaseRoute()).put(`/users/${TestHelper.basicUser.id}/preferences`).reply(200, OK_RESPONSE)
  ...
  it('autocompleteChannels', async () => {
    ...
    const result = await store.dispatch(Actions.autocompleteChannels(TestHelper.basicChannel.team_id, prefix))
  ...
  it('autocompleteChannelsForSearch', async () => {
    ...
    const result = await store.dispatch(Actions.autocompleteChannelsForSearch(TestHelper.basicChannel.team_id, prefix))
  ...
  it('updateChannelMemberSchemeRoles', async () => {
    ...
    const userId = TestHelper.basicChannelMember.user_id
    ...
    nock(Client4.getBaseRoute()).put(`/channels/${channelId}/members/${userId}/schemeRoles`).reply(200, OK_RESPONSE)
  ...
  it('membersMinusGroupMembers', async () => {
    ...
    nock(Client4.getBaseRoute())
      .get(
        `/channels/${channelID}/members_minus_group_members?group_ids=${groupIDs.join(
          ','
  ...
  it('patchChannelModerations', async () => {
    ...
    const { error } = await store.dispatch(Actions.patchChannelModerations(channelID, {} as any))
    const moderations = store.getState().entities.channels.channelModerations[channelID]
  ...
  it('getChannelMemberCountsByGroup', async () => {
    ...
    nock(Client4.getBaseRoute())
      .get(`/channels/${channelID}/member_counts_by_group?include_timezones=true`)
      .reply(200, [
        {
          group_id: 'group-1',

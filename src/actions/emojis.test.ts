...
describe('Actions.Emojis', () => {
  ...
  it('getCustomEmojis', async () => {
    ...
    nock(Client4.getBaseRoute()).get('/emoji').query(true).reply(200, [created])
  ...
  it('getAllCustomEmojis', async () => {
    ...
    nock(Client4.getBaseRoute()).get('/emoji').query(true).reply(200, [created1])

    nock(Client4.getBaseRoute()).get('/emoji').query(true).reply(200, [created2])

    nock(Client4.getBaseRoute()).get('/emoji').query(true).reply(200, [])
    ...
    nock(Client4.getBaseRoute()).delete(`/emoji/${created2.id}`).reply(200, OK_RESPONSE)
    ...
    nock(Client4.getBaseRoute()).delete(`/emoji/${created1.id}`).reply(200, OK_RESPONSE)
  ...
  it('deleteCustomEmoji', async () => {
    ...
    nock(Client4.getBaseRoute()).delete(`/emoji/${created.id}`).reply(200, OK_RESPONSE)
  ...
  it('loadProfilesForCustomEmojis', async () => {
    ...
    nock(Client4.getUsersRoute()).post('/ids').reply(200, [TestHelper.basicUser, fakeUser])
  ...
  it('searchCustomEmojis', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/emoji/search').reply(200, [created])
  ...
  it('autocompleteCustomEmojis', async () => {
    ...
    nock(Client4.getBaseRoute()).get('/emoji/autocomplete').query(true).reply(200, [created])
  ...
  it('getCustomEmoji', async () => {
    ...
    nock(Client4.getBaseRoute()).get(`/emoji/${created.id}`).reply(200, created)
  ...
  it('getCustomEmojiByName', async () => {
    ...
    nock(Client4.getBaseRoute()).get(`/emoji/name/${created.name}`).reply(200, created)

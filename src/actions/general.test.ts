...
describe('Actions.General', () => {
  ...
  it('getPing - Invalid URL', async () => {
    ...
    nock(Client4.getBaseRoute()).get('/system/ping').query(true).reply(401, { error: 'ping error', code: 401 })
  ...
  it('getPing', async () => {
    ...
    nock(Client4.getBaseRoute()).get('/system/ping').query(true).reply(200, response)
  ...
  it('getLicenseConfig', async () => {
    nock(Client4.getBaseRoute()).get('/license/client').query(true).reply(200, { IsLicensed: 'false' })
  ...
  it('getDataRetentionPolicy', async () => {
    ...
    nock(Client4.getBaseRoute()).get('/data_retention/policy').query(true).reply(200, responseData)
  ...
  it('getWarnMetricsStatus', async () => {
    ...
    nock(Client4.getBaseRoute()).get('/warn_metrics/status').query(true).reply(200, responseData)
  ...
  describe('getRedirectLocation', () => {
    it('old server', async () => {
      ...
      const mock = nock(Client4.getBaseRoute()).get('/redirect_location').reply(404)

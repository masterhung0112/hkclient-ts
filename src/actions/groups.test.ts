...
describe('Actions.Groups', () => {
  ...
  it('getGroupSyncables', async () => {
    ...
    nock(Client4.getBaseRoute()).get(`/groups/${groupID}/teams`).reply(200, groupTeams)

    nock(Client4.getBaseRoute()).get(`/groups/${groupID}/channels`).reply(200, groupChannels)
  ...
  it('getGroup', async () => {
    ...
    nock(Client4.getBaseRoute()).get(`/groups/${groupID}`).reply(200, response)
  ...
  it('linkGroupSyncable', async () => {
    ...
    nock(Client4.getBaseRoute()).post(`/groups/${groupID}/teams/${teamID}/link`).reply(200, groupTeamResponse)
  ...
  it('unlinkGroupSyncable', async () => {
    ...
    nock(Client4.getBaseRoute()).delete(`/groups/${groupID}/teams/${teamID}/link`).reply(204, { ok: true })

    nock(Client4.getBaseRoute()).delete(`/groups/${groupID}/channels/${channelID}/link`).reply(204, { ok: true })
  ...
  it('getGroupsAssociatedToChannel', async () => {
    ...
    nock(Client4.getBaseRoute())
      .get(
        `/channels/${channelID}/groups?page=100&per_page=60&q=0&include_member_count=true&filter_allow_reference=false`
      )
      .reply(200, response)
  ...
  it('patchGroupSyncable', async () => {
    ...
    nock(Client4.getBaseRoute()).put(`/groups/${groupID}/teams/${teamID}/patch`).reply(200, groupTeamResponse)

    nock(Client4.getBaseRoute()).put(`/groups/${groupID}/channels/${channelID}/patch`).reply(200, groupChannelResponse)

    await Actions.patchGroupSyncable(
      groupID,
      teamID,
      Groups.SYNCABLE_TYPE_TEAM,
      groupSyncablePatch
  ...
  it('patchGroup', async () => {
    ...
    nock(Client4.getBaseRoute()).put(`/groups/${groupID}/patch`).reply(200, response)
  ...
  it('getGroupStats', async () => {
    ...
    nock(Client4.getBaseRoute()).get(`/groups/${groupID}/stats`).reply(200, response)

...
describe('Actions.Integrations', () => {
  ...
  it('getAutocompleteCommands', async () => {
    ...
    await Actions.getAutocompleteCommands(team.id)(store.dispatch, store.getState)
  ...
  it('getCustomTeamCommands', async () => {
    ...
    await Actions.getCustomTeamCommands(team.id)(store.dispatch, store.getState)
  ...
  it('regenCommandToken', async () => {
    ...
    await Actions.regenCommandToken(created.id)(store.dispatch, store.getState)

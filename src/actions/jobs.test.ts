...
describe('Actions.Jobs', () => {
  ...
  it('getJob', async () => {
    nock(Client4.getBaseRoute()).get('/jobs/six4h67ja7ntdkek6g13dp3wka').reply(200, {
      id: 'six4h67ja7ntdkek6g13dp3wka',
      create_at: 1491399241953,
      type: 'data_retention',
      status: 'pending',
  ...
  it('cancelJob', async () => {
    nock(Client4.getBaseRoute()).post('/jobs/six4h67ja7ntdkek6g13dp3wka/cancel').reply(200, OK_RESPONSE)

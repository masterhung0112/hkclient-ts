...
describe('Actions.Teams', () => {
  ...
  it('getMyTeams', async () => {
    ...
    nock(Client4.getBaseRoute()).get('/users/me/teams').reply(200, [TestHelper.basicTeam])
  ...
  it('getTeamsForUser', async () => {
    nock(Client4.getBaseRoute()).get(`/users/${TestHelper.basicUser.id}/teams`).reply(200, [TestHelper.basicTeam])
  ...
  it('getTeams', async () => {
    ...
    nock(Client4.getBaseRoute()).get('/teams').query(true).reply(200, [team])
  ...
  it('getTeam', async () => {
    ...
    nock(Client4.getBaseRoute()).get(`/teams/${team.id}`).reply(200, team)
  ...
  it('getTeamByName', async () => {
    ...
    nock(Client4.getBaseRoute()).get(`/teams/name/${team.name}`).reply(200, team)
  ...
  it('createTeam', async () => {
    nock(Client4.getBaseRoute()).post('/teams').reply(201, TestHelper.fakeTeamWithId())
    await Actions.createTeam(TestHelper.fakeTeam())(store.dispatch, store.getState)
  ...
  it('deleteTeam', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/teams').reply(201, TestHelper.fakeTeamWithId())
    const secondTeam = await secondClient.createTeam(TestHelper.fakeTeam())

    nock(Client4.getBaseRoute()).delete(`/teams/${secondTeam.id}`).reply(200, OK_RESPONSE)

    await Actions.deleteTeam(secondTeam.id)(store.dispatch, store.getState)
  ...
  it('updateTeam', async () => {
    ...
    nock(Client4.getBaseRoute()).put(`/teams/${team.id}`).reply(200, team)
  ...
  it('patchTeam', async () => {
    ...
    nock(Client4.getBaseRoute()).put(`/teams/${team.id}/patch`).reply(200, team)
  ...
  it('regenerateTeamInviteId', async () => {
    ...
    nock(Client4.getBaseRoute()).post(`/teams/${team.id}/regenerate_invite_id`).reply(200, patchedTeam)
  ...
  it('Join Open Team', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/users').query(true).reply(201, TestHelper.fakeUserWithId())
    const user = await client.createUser(TestHelper.fakeUser(), null, null, TestHelper.basicTeam.invite_id)
  ...
  it('getTeamMembersByIds', async () => {
    ...
    nock(Client4.getBaseRoute())
      ...
      .reply(200, [
        { user_id: user1.id, team_id: TestHelper.basicTeam.id },
        { user_id: user2.id, team_id: TestHelper.basicTeam.id },
      ])
    await Actions.getTeamMembersByIds(TestHelper.basicTeam.id, [user1.id, user2.id])(store.dispatch, store.getState)
  ...
  it('addUsersToTeam', async () => {
    ...
    nock(Client4.getTeamRoute(TestHelper.basicTeam.id))
      .post('/members/batch')
      .reply(201, [
        { user_id: user.id, team_id: TestHelper.basicTeam.id },
        { user_id: user2.id, team_id: TestHelper.basicTeam.id },
      ])
  ...
  describe('removeUserFromTeam', () => {
    ...
    test('should remove the user from the team', async () => {
      ...
      nock(Client4.getBaseRoute()).delete(`/teams/${team.id}/members/${user.id}`).reply(200, OK_RESPONSE)
  ...
  it('searchTeams', async () => {
    ...
    const userTeam = await userClient.createTeam(TestHelper.fakeTeam())

    nock(Client4.getBaseRoute()).post('/teams/search').reply(200, [TestHelper.basicTeam, userTeam])

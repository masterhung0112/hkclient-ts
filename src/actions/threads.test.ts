...
import { getThread as fetchThread, getThreads as fetchThreads } from 'actions/threads'

import { getThread, getThreadsInCurrentTeam } from 'selectors/entities/threads'

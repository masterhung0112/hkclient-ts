...
describe('Actions.Users', () => {
  ...
  it('login', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/users/logout').reply(200, OK_RESPONSE)
  ...
  it('getTermsOfService', async () => {
    ...
    nock(Client4.getBaseRoute()).get('/terms_of_service').reply(200, response)
  ...
  it('updateMyTermsOfServiceStatus accept terms', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/users/me/terms_of_service').reply(200, OK_RESPONSE)
  ...
  it('logout', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/users/login').reply(200, TestHelper.basicUser)
    await TestHelper.basicClient4.login(TestHelper.basicUser.email, 'password1')
  })

  it('getProfiles', async () => {
    nock(Client4.getBaseRoute()).get('/users').query(true).reply(200, [TestHelper.basicUser])
  ...
  it('getProfilesByUsernames', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/users/usernames').reply(200, [user])
  ...
  it('getProfilesNotInTeam', async () => {
    ...
    nock(Client4.getBaseRoute()).get('/users').query(true).reply(200, [user])
  ...
  it('getProfilesInChannel', async () => {
    ...
    await Actions.getProfilesInChannel(TestHelper.basicChannel.id, 0)(store.dispatch, store.getState)
  ...
  it('getProfilesNotInChannel', async () => {
    nock(Client4.getBaseRoute()).post('/users').query(true).reply(200, TestHelper.fakeUserWithId())
  ...
  it('searchProfiles', async () => {
    ...
    await Actions.searchProfiles(user.username)(store.dispatch, store.getState)
  ...
  it('getStatusesByIds', async () => {
    nock(Client4.getBaseRoute())
      ...
      .reply(200, [
        { user_id: TestHelper.basicUser.id, status: 'online', manual: false, last_activity_at: 1507662212199 },
      ])

    await Actions.getStatusesByIds([TestHelper.basicUser.id])(store.dispatch, store.getState)
  ...
  it('getTotalUsersStats', async () => {
    nock(Client4.getBaseRoute()).get('/users/stats').reply(200, { total_users_count: 2605 })
  ...
  it('setStatus', async () => {
    nock(Client4.getBaseRoute()).put(`/users/${TestHelper.basicUser.id}/status`).reply(200, OK_RESPONSE)

    await Actions.setStatus({ user_id: TestHelper.basicUser.id, status: 'away' } as UserStatus)(
      store.dispatch,
      store.getState
    )
  ...
  it('revokeSession', async () => {
    ...
    nock(Client4.getBaseRoute()).post(`/users/${TestHelper.basicUser.id}/sessions/revoke`).reply(200, OK_RESPONSE)
  ...
  it('revokeSession and logout', async () => {
    ...
    const { data: revokeSessionResponse } = (await Actions.revokeSession(TestHelper.basicUser.id, sessions[0].id)(
      store.dispatch,
      store.getState
    )) as ActionResult
    ...
    nock(Client4.getBaseRoute()).post('/users/login').reply(200, basicUser)
  ...
  it('revokeAllSessionsForCurrentUser', async () => {
    ...
    nock(Client4.getBaseRoute()).post(`/users/${user.id}/sessions/revoke/all`).reply(200, OK_RESPONSE)
  ...
  it('revokeSessionsForAllUsers', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/users/sessions/revoke/all').reply(200, OK_RESPONSE)
  ...
  it('updateUserRoles', async () => {
    ...
    nock(Client4.getBaseRoute()).put(`/users/${currentUserId}/roles`).reply(200, OK_RESPONSE)
  ...
  it('updateUserMfa', async () => {
    ...
    nock(Client4.getBaseRoute()).put(`/users/${currentUserId}/mfa`).reply(200, OK_RESPONSE)
  ...
  it('updateUserPassword', async () => {
    ...
    nock(Client4.getBaseRoute()).put(`/users/${currentUserId}/password`).reply(200, OK_RESPONSE)
  ...
  it('checkMfa', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/users/mfa').reply(200, { mfa_required: false })

    const { data: mfaRequired } = (await Actions.checkMfa(user.email)(store.dispatch, store.getState)) as ActionResult
  ...
  it('generateMfaSecret', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/users/me/mfa/generate').reply(200, response)
  ...
  it('updateUserActive', async () => {
    ...
    const { data: user } = (await Actions.createUser(TestHelper.fakeUser())(
      store.dispatch,
      store.getState
    )) as ActionResult
    ...
    nock(Client4.getBaseRoute()).put(`/users/${user.id}/active`).reply(200, OK_RESPONSE)
  ...
  it('verifyUserEmail', async () => {
    nock(Client4.getBaseRoute()).post('/users/email/verify').reply(200, OK_RESPONSE)
  ...
  it('sendVerificationEmail', async () => {
    nock(Client4.getBaseRoute()).post('/users/email/verify/send').reply(200, OK_RESPONSE)

    const { data } = (await Actions.sendVerificationEmail(TestHelper.basicUser.email)(
      store.dispatch,
      store.getState
    )) as ActionResult
  ...
  it('resetUserPassword', async () => {
    nock(Client4.getBaseRoute()).post('/users/password/reset').reply(200, OK_RESPONSE)

    const { data } = (await Actions.resetUserPassword('sometoken', 'newpassword')(
      store.dispatch,
      store.getState
    )) as ActionResult
  ...
  it('sendPasswordResetEmail', async () => {
    nock(Client4.getBaseRoute()).post('/users/password/reset/send').reply(200, OK_RESPONSE)

    const { data } = (await Actions.sendPasswordResetEmail(TestHelper.basicUser.email)(
      store.dispatch,
      store.getState
    )) as ActionResult
  ...
  it('uploadProfileImage', async () => {
    ...
    nock(Client4.getBaseRoute()).post(`/users/${TestHelper.basicUser.id}/image`).reply(200, OK_RESPONSE)
  ...
  it('setDefaultProfileImage', async () => {
    ...
    nock(Client4.getBaseRoute()).delete(`/users/${TestHelper.basicUser.id}/image`).reply(200, OK_RESPONSE)
  ...
  it('switchEmailToOAuth', async () => {
    nock(Client4.getBaseRoute()).post('/users/login/switch').reply(200, { follow_link: '/login' })
  ...
  it('createUserAccessToken', (done) => {
    async function test() {
      ...
      const { data } = (await Actions.createUserAccessToken(currentUserId, 'test token')(
        store.dispatch,
        store.getState
      )) as ActionResult
  ...
  it('revokeUserAccessToken', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/users/tokens/revoke').reply(200, OK_RESPONSE)
  ...
  it('disableUserAccessToken', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/users/tokens/disable').reply(200, OK_RESPONSE)
  ...
  it('enableUserAccessToken', async () => {
    ...
    nock(Client4.getBaseRoute()).post('/users/tokens/enable').reply(200, OK_RESPONSE)

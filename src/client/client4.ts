...
import { ClientConfig, ClientLicense, DataRetentionPolicy, License, AdminConfig, EnvironmentConfig } from 'types/config'
...
export default class Client44 {
  ...
  updateUser = (user: UserProfile) => {
    ...
    return this.doFetch<UserProfile>(`${this.getUserRoute(user.id)}`, { method: 'put', body: JSON.stringify(user) })
  }
  ...
  updateUserMfa = (userId: string, activate: boolean, code: string) => {
    ...
    return this.doFetch<StatusOK>(`${this.getUserRoute(userId)}/mfa`, { method: 'put', body: JSON.stringify(body) })
  }
  ...
  getKnownUsers = () => {
    ...
    return this.doFetch<Array<$ID<UserProfile>>>(`${this.getUsersRoute()}/known`, { method: 'get' })
  }
  ...
  login = (loginId: string, password: string, token = '', deviceId = '', ldapOnly = false) => {
    ...
    return this.doFetch<UserProfile>(`${this.getUsersRoute()}/login`, { method: 'post', body: JSON.stringify(body) })
  }
  ...
  getProfilesNotInTeam = (teamId: string, groupConstrained: boolean, page = 0, perPage = PER_PAGE_DEFAULT) => {
    ...
    return this.doFetch<UserProfile[]>(`${this.getUsersRoute()}${buildQueryString(queryStringObj)}`, { method: 'get' })
  }
  ...
  switchEmailToOAuth = (service: string, email: string, password: string, mfaCode = '') => {
    ...
    return this.doFetch<AuthChangeResponse>(`${this.getUsersRoute()}/login/switch`, {
      method: 'post',
      body: JSON.stringify({ current_service: 'email', new_service: service, email, password, mfa_code: mfaCode }),
    })
  }
  ...
  switchOAuthToEmail = (currentService: string, email: string, password: string) => {
    ...
    return this.doFetch<AuthChangeResponse>(`${this.getUsersRoute()}/login/switch`, {
      method: 'post',
      body: JSON.stringify({ current_service: currentService, new_service: 'email', email, new_password: password }),
    })
  }
  ...
  createTeam = (team: Team) => {
    ...
    return this.doFetch<Team>(`${this.getTeamsRoute()}`, { method: 'post', body: JSON.stringify(team) })
  }
  ...
  updateTeam = (team: Team) => {
    ...
    return this.doFetch<Team>(`${this.getTeamRoute(team.id)}`, { method: 'put', body: JSON.stringify(team) })
  }

  patchTeam = (team: Partial<Team> & { id: string }) => {
    this.trackEvent('api', 'api_teams_patch_name', { team_id: team.id })

    return this.doFetch<Team>(`${this.getTeamRoute(team.id)}/patch`, { method: 'put', body: JSON.stringify(team) })
  }
  ...
  updateTeamScheme = (teamId: string, schemeId: string) => {
    ...
    return this.doFetch<StatusOK>(`${this.getTeamSchemeRoute(teamId)}`, { method: 'put', body: JSON.stringify(patch) })
  }
  ...
  sendEmailGuestInvitesToChannelsGracefully = async (
    ...
    return this.doFetch<TeamInviteWithError>(`${this.getTeamRoute(teamId)}/invite-guests/email?graceful=true`, {
      method: 'post',
      body: JSON.stringify({ emails, channels: channelIds, message }),
    })
  }
  ...
  createChannel = (channel: Channel) => {
    ...
    return this.doFetch<Channel>(`${this.getChannelsRoute()}`, { method: 'post', body: JSON.stringify(channel) })
  }

  createDirectChannel = (userIds: string[]) => {
    this.trackEvent('api', 'api_channels_create_direct')

    return this.doFetch<Channel>(`${this.getChannelsRoute()}/direct`, { method: 'post', body: JSON.stringify(userIds) })
  }

  createGroupChannel = (userIds: string[]) => {
    this.trackEvent('api', 'api_channels_create_group')

    return this.doFetch<Channel>(`${this.getChannelsRoute()}/group`, { method: 'post', body: JSON.stringify(userIds) })
  }
  ...
  patchChannelModerations = (channelId: string, channelModerationsPatch: ChannelModerationPatch[]) => {
    return this.doFetch<ChannelModeration[]>(`${this.getChannelRoute(channelId)}/moderations/patch`, {
      method: 'put',
      body: JSON.stringify(channelModerationsPatch),
    })
  }
  ...
  autocompleteChannels = (teamId: string, name: string) => {
    return this.doFetch<Channel[]>(`${this.getTeamRoute(teamId)}/channels/autocomplete${buildQueryString({ name })}`, {
      method: 'get',
    })
  }
  ...
  createPost = async (post: Post) => {
    const result = await this.doFetch<Post>(`${this.getPostsRoute()}`, { method: 'post', body: JSON.stringify(post) })
    const analyticsData = {
  ...
  updatePost = (post: Post) => {
    ...
    return this.doFetch<Post>(`${this.getPostRoute(post.id)}`, { method: 'put', body: JSON.stringify(post) })
  }
  ...
  getUserThread = (userId: string, teamId: string, threadId: string, extended = false) => {
    ...
    return this.doFetch<UserThreadWithPost>(`${url}${buildQueryString({ extended })}`, { method: 'get' })
  }
  ...
  markPostAsUnread = (userId: string, postId: string) => {
    ...
    return this.doFetch<ChannelUnread>(`${this.getUserRoute(userId)}/posts/${postId}/set_unread`, { method: 'post' })
  }
  ...
  doPostActionWithCookie = (postId: string, actionId: string, actionCookie: string, selectedOption = '') => {
    ...
    return this.doFetch<PostActionResponse>(`${this.getPostRoute(postId)}/actions/${encodeURIComponent(actionId)}`, {
      method: 'post',
  ...
  getClientConfigOld = () => {
    return this.doFetch<ClientConfig>(`${this.getBaseRoute()}/config/client?format=old`, { method: 'get' })
  }
  ...
  getCustomTeamCommands = (teamId: string) => {
    return this.doFetch<Command[]>(`${this.getCommandsRoute()}?team_id=${teamId}&custom_only=true`, { method: 'get' })
  }
  ...
  addCommand = (command: Command) => {
    ...
    return this.doFetch<Command>(`${this.getCommandsRoute()}`, { method: 'post', body: JSON.stringify(command) })
  }
  ...
  createOAuthApp = (app: OAuthApp) => {
    ...
    return this.doFetch<OAuthApp>(`${this.getOAuthAppsRoute()}`, { method: 'post', body: JSON.stringify(app) })
  }

  editOAuthApp = (app: OAuthApp) => {
    return this.doFetch<OAuthApp>(`${this.getOAuthAppsRoute()}/${app.id}`, { method: 'put', body: JSON.stringify(app) })
  }
  ...
  getJobsByType = (type: string, page = 0, perPage = PER_PAGE_DEFAULT) => {
    return this.doFetch<Job[]>(`${this.getJobsRoute()}/type/${type}${buildQueryString({ page, per_page: perPage })}`, {
      method: 'get',
    })
  }

  createJob = (job: Job) => {
    return this.doFetch<Job>(`${this.getJobsRoute()}`, { method: 'post', body: JSON.stringify(job) })
  }
  ...
  getLogs = (page = 0, perPage = LOGS_PER_PAGE_DEFAULT) => {
    return this.doFetch<string[]>(`${this.getBaseRoute()}/logs${buildQueryString({ page, logs_per_page: perPage })}`, {
      method: 'get',
    })
  }
  ...
  updateConfig = (config: AdminConfig) => {
    return this.doFetch<AdminConfig>(`${this.getBaseRoute()}/config`, { method: 'put', body: JSON.stringify(config) })
  }
  ...
  testEmail = (config: AdminConfig) => {
    return this.doFetch<StatusOK>(`${this.getBaseRoute()}/email/test`, { method: 'post', body: JSON.stringify(config) })
  }
  ...
  purgeElasticsearchIndexes = () => {
    return this.doFetch<StatusOK>(`${this.getBaseRoute()}/elasticsearch/purge_indexes`, { method: 'post' })
  }
  ...
  getRolesByNames = (rolesNames: string[]) => {
    return this.doFetch<Role[]>(`${this.getRolesRoute()}/names`, { method: 'post', body: JSON.stringify(rolesNames) })
  }
  ...
  getSchemes = (scope = '', page = 0, perPage = PER_PAGE_DEFAULT) => {
    return this.doFetch<Scheme[]>(`${this.getSchemesRoute()}${buildQueryString({ scope, page, per_page: perPage })}`, {
      method: 'get',
    })
  }
  ...
  createScheme = (scheme: Scheme) => {
    ...
    return this.doFetch<Scheme>(`${this.getSchemesRoute()}`, { method: 'post', body: JSON.stringify(scheme) })
  }
  ...
  installPluginFromUrl = (pluginDownloadUrl: string, force = false) => {
    ...
    return this.doFetch<PluginManifest>(`${this.getPluginsRoute()}/install_from_url${buildQueryString(queryParams)}`, {
      method: 'post',
    })
  }
  ...
  patchGroup = (groupID: string, patch: GroupPatch) => {
    return this.doFetch<Group>(`${this.getGroupRoute(groupID)}/patch`, { method: 'put', body: JSON.stringify(patch) })
  }
  ...
  createBot = (bot: Bot) => {
    return this.doFetch<Bot>(`${this.getBotsRoute()}`, { method: 'post', body: JSON.stringify(bot) })
  }

  patchBot = (botUserId: string, botPatch: BotPatch) => {
    return this.doFetch<Bot>(`${this.getBotRoute(botUserId)}`, { method: 'put', body: JSON.stringify(botPatch) })
  }
  ...
  getSubscriptionStats = () => {
    return this.doFetch<SubscriptionStats>(`${this.getCloudRoute()}/subscription/stats`, { method: 'get' })
  }
  ...
  teamMembersMinusGroupMembers = (teamID: string, groupIDs: string[], page: number, perPage: number) => {
    ...
    return this.doFetch<UsersWithGroupsAndCount>(`${this.getTeamRoute(teamID)}/members_minus_group_members?${query}`, {
      method: 'get',
    })
  }
  ...
  updateNoticesAsViewed = (noticeIds: string[]) => {
    ...
    return this.doFetch<StatusOK>(`${this.getNoticesRoute()}/view`, { method: 'put', body: JSON.stringify(noticeIds) })
  }

  sendAdminUpgradeRequestEmail = () => {
    return this.doFetch<StatusOK>(`${this.getCloudRoute()}/subscription/limitreached/invite`, { method: 'post' })
  }

  sendAdminUpgradeRequestEmailOnJoin = () => {
    return this.doFetch<StatusOK>(`${this.getCloudRoute()}/subscription/limitreached/join`, { method: 'post' })
  }

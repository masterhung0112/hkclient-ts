...
values.SYSCONSOLE_ANCILLARY_PERMISSIONS = {
  ...
  [values.SYSCONSOLE_READ_USERMANAGEMENT_USERS]: [values.READ_OTHER_USERS_TEAMS],
  [values.SYSCONSOLE_READ_USERMANAGEMENT_TEAMS]: [
    values.LIST_PRIVATE_TEAMS,
    values.LIST_PUBLIC_TEAMS,
    values.VIEW_TEAM,
  ],
  [values.SYSCONSOLE_WRITE_COMPLIANCE]: [values.MANAGE_JOBS],
  [values.SYSCONSOLE_READ_COMPLIANCE]: [values.READ_JOBS, values.DOWNLOAD_COMPLIANCE_EXPORT_RESULT],
  [values.SYSCONSOLE_READ_ENVIRONMENT]: [values.READ_JOBS],
  [values.SYSCONSOLE_READ_AUTHENTICATION]: [values.READ_JOBS],
  [values.SYSCONSOLE_READ_REPORTING]: [values.VIEW_TEAM],
  [values.SYSCONSOLE_WRITE_USERMANAGEMENT_USERS]: [
  ...
  [values.SYSCONSOLE_WRITE_ENVIRONMENT]: [values.MANAGE_JOBS],
  [values.SYSCONSOLE_WRITE_SITE]: [values.EDIT_BRAND],
}

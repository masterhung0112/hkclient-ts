...
Permissions.SYSCONSOLE_READ_PERMISSIONS = [
  Permissions.SYSCONSOLE_READ_ABOUT,
  Permissions.SYSCONSOLE_READ_BILLING,
  Permissions.SYSCONSOLE_READ_REPORTING,
  ...
  Permissions.SYSCONSOLE_READ_SITE,
  Permissions.SYSCONSOLE_READ_AUTHENTICATION,
  Permissions.SYSCONSOLE_READ_PLUGINS,
  Permissions.SYSCONSOLE_READ_INTEGRATIONS,
  Permissions.SYSCONSOLE_READ_COMPLIANCE,
  Permissions.SYSCONSOLE_READ_EXPERIMENTAL,
]

Permissions.SYSCONSOLE_WRITE_PERMISSIONS = [
  Permissions.SYSCONSOLE_WRITE_ABOUT,
  Permissions.SYSCONSOLE_WRITE_BILLING,
  Permissions.SYSCONSOLE_WRITE_REPORTING,
  ...
  Permissions.SYSCONSOLE_WRITE_ENVIRONMENT,
  Permissions.SYSCONSOLE_WRITE_SITE,
  Permissions.SYSCONSOLE_WRITE_AUTHENTICATION,
  Permissions.SYSCONSOLE_WRITE_PLUGINS,
  Permissions.SYSCONSOLE_WRITE_INTEGRATIONS,
  Permissions.SYSCONSOLE_WRITE_COMPLIANCE,
  Permissions.SYSCONSOLE_WRITE_EXPERIMENTAL,
]

Permissions.SYSCONSOLE_ANCILLARY_PERMISSIONS = {
  [Permissions.SYSCONSOLE_READ_USERMANAGEMENT_CHANNELS]: [
  ...
  [Permissions.SYSCONSOLE_READ_USERMANAGEMENT_USERS]: [Permissions.READ_OTHER_USERS_TEAMS],
  [Permissions.SYSCONSOLE_READ_USERMANAGEMENT_TEAMS]: [
    Permissions.LIST_PRIVATE_TEAMS,
    Permissions.LIST_PUBLIC_TEAMS,
    Permissions.VIEW_TEAM,
  ],
  [Permissions.SYSCONSOLE_WRITE_COMPLIANCE]: [Permissions.MANAGE_JOBS],
  [Permissions.SYSCONSOLE_READ_COMPLIANCE]: [Permissions.READ_JOBS, Permissions.DOWNLOAD_COMPLIANCE_EXPORT_RESULT],
  [Permissions.SYSCONSOLE_READ_ENVIRONMENT]: [Permissions.READ_JOBS],
  [Permissions.SYSCONSOLE_READ_AUTHENTICATION]: [Permissions.READ_JOBS],
  [Permissions.SYSCONSOLE_READ_REPORTING]: [Permissions.VIEW_TEAM],
  [Permissions.SYSCONSOLE_WRITE_USERMANAGEMENT_USERS]: [
  ...
  [Permissions.SYSCONSOLE_WRITE_ENVIRONMENT]: [Permissions.MANAGE_JOBS],
  [Permissions.SYSCONSOLE_WRITE_SITE]: [Permissions.EDIT_BRAND],
}

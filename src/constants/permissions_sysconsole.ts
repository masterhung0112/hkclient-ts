...
export const ResourceToSysConsolePermissionsTable: Record<string, string[]> = {
  ...
  'user_management.users': [
    Permissions.SYSCONSOLE_READ_USERMANAGEMENT_USERS,
    Permissions.SYSCONSOLE_WRITE_USERMANAGEMENT_USERS,
  ],
  'user_management.groups': [
    Permissions.SYSCONSOLE_READ_USERMANAGEMENT_GROUPS,
    Permissions.SYSCONSOLE_WRITE_USERMANAGEMENT_GROUPS,
  ],
  'user_management.teams': [
    Permissions.SYSCONSOLE_READ_USERMANAGEMENT_TEAMS,
    Permissions.SYSCONSOLE_WRITE_USERMANAGEMENT_TEAMS,
  ],
  'user_management.channels': [
    Permissions.SYSCONSOLE_READ_USERMANAGEMENT_CHANNELS,
    Permissions.SYSCONSOLE_WRITE_USERMANAGEMENT_CHANNELS,
  ],
  'user_management.permissions': [
    Permissions.SYSCONSOLE_READ_USERMANAGEMENT_PERMISSIONS,
    Permissions.SYSCONSOLE_WRITE_USERMANAGEMENT_PERMISSIONS,
  ],
  'user_management.system_roles': [
    Permissions.SYSCONSOLE_READ_USERMANAGEMENT_SYSTEM_ROLES,
    Permissions.SYSCONSOLE_WRITE_USERMANAGEMENT_SYSTEM_ROLES,
  ],

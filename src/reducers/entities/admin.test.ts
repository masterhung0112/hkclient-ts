...
import { Plugins } from 'hkconstants/plugins'
...
describe('reducers.entities.admin', () => {
  describe('pluginStatuses', () => {
    it('initial state', () => {
      ...
      const actualState = reducer({ pluginStatuses: state } as any, action as any)
        ...
        data: [
          {
            ...
            version: '0.1.0',
            state: Plugins.PLUGIN_STATE_NOT_RUNNING,
            name: 'Plugin 0',
          ...
          },
          {
            ...
            version: '0.0.2',
            state: Plugins.PLUGIN_STATE_RUNNING,
            name: 'Plugin 1',
  ...
  describe('convertAnalyticsRowsToStats', () => {
    it('data should not be mutated', () => {
      const data = deepFreezeAndThrowOnMutation([
        { name: '1', value: 1 },
        { name: '2', value: 2 },
        { name: '3', value: 3 },
      ])
  ...
  describe('ldapGroups', () => {
    it('initial state', () => {
      ...
      const actualState = reducer({ ldapGroups: state } as any, action as any)

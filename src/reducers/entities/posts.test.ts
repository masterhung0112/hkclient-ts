...
import { ChannelTypes, GeneralTypes, PostTypes } from 'action-types'
...
describe('postsInChannel', () => {
  describe('receiving a new post', () => {
    ...
    it('should store the new post when the channel has recent posts', () => {
      ...
      expect(nextState).not.toBe(state)
      expect(nextState).toEqual({
        channel1: [{ order: ['post1', 'post2', 'post3'], recent: true }],
      })
    })
    ...
    it('should remove a previously pending post', () => {
      const state = deepFreeze({
        channel1: [{ order: ['pending', 'post2', 'post1'], recent: true }],
      })
      ...
      const nextState = reducers.postsInChannel(
        ...
        {},
        { post1: { create_at: 1 }, post2: { create_at: 2 }, post3: { create_at: 3 } } as any
      )

      expect(nextState).not.toBe(state)
      expect(nextState).toEqual({
        channel1: [{ order: ['post3', 'post2', 'post1'], recent: true }],
      })
    })
    ...
    it('should just add the new post if the pending post was already removed', () => {
      ...
      expect(nextState).not.toBe(state)
      expect(nextState).toEqual({
        channel1: [{ order: ['post3', 'post1', 'post2'], recent: true }],
      })
    })
  ...
  describe('receiving a single post', () => {
    it('should replace a previously pending post', () => {
      const state = deepFreeze({
        channel1: [{ order: ['post1', 'pending', 'post2'], recent: true }],
      })
      ...
      expect(nextState).not.toBe(state)
      expect(nextState).toEqual({
        channel1: [{ order: ['post1', 'post3', 'post2'], recent: true }],
      })
    })
  ...
  describe('receiving consecutive recent posts in the channel', () => {
    it('should save posts in the correct order', () => {
      ...
      expect(nextState).not.toBe(state)
      expect(nextState).toEqual({
        channel1: [{ order: ['post1', 'post2', 'post3', 'post4'], recent: true }],
      })
    })
  ...
  describe('receiving consecutive posts in the channel that are not recent', () => {
    it('should save posts in the correct order', () => {
      ...
      expect(nextState).not.toBe(state)
      expect(nextState).toEqual({
        channel1: [{ order: ['post1', 'post2', 'post3', 'post4'], recent: false }],
      })
    })

    it('should not save duplicate posts', () => {
      const state = deepFreeze({
        channel1: [{ order: ['post1', 'post2', 'post3'], recent: false }],
      })
    ...
    it('should save with chunk as oldest', () => {
      ...
      expect(nextState).not.toBe(state)
      expect(nextState).toEqual({
        channel1: [{ order: ['post1', 'post2', 'post3'], recent: true, oldest: true }],
      })
    })
  })
  ...
  describe('receiving posts before', () => {
    ...
    it('should have oldest set to false', () => {
      ...
      expect(nextState).not.toBe(state)
      expect(nextState).toEqual({
        channel1: [{ order: ['post1', 'post2', 'post3'], recent: false, oldest: false }],
      })
    })
  ...
  describe('deleting a post', () => {
    ...
    it('should remove comments on the post when deleting a post with comments', () => {
      ...
      expect(nextState).not.toBe(state)
      expect(nextState).toEqual({
        channel1: [{ order: ['post1', 'post3', 'post4'], recent: false }],
      })
    })
...
describe('mergePostBlocks', () => {
  ...
  it('should do nothing with only one block', () => {
    const blocks = [{ order: ['a'], recent: false }]
    const posts = {
      a: { create_at: 1000 },
    } as any
  ...
  it('should merge two blocks containing overlapping posts', () => {
    ...
    expect(nextBlocks).not.toBe(blocks)
    expect(nextBlocks).toEqual([{ order: ['a', 'b', 'c', 'd'], recent: false }])
  })
  ...
  it('should merge more than two blocks containing overlapping posts', () => {
    ...
    expect(nextBlocks).not.toBe(blocks)
    expect(nextBlocks).toEqual([{ order: ['a', 'b', 'c', 'd', 'e'], recent: false }])
  })
...
describe('removeUnneededMetadata', () => {
  ...
  it('should not affect non-OpenGraph embeds', () => {
    const post = deepFreeze({
      id: 'post',
      metadata: {
        embeds: [{ type: 'image', url: 'https://example.com/image' }, { type: 'message_attachment' }],
      },
      props: {
...
describe('reactions', () => {
  for (const actionType of [PostTypes.RECEIVED_NEW_POST, PostTypes.RECEIVED_POST]) {
        ...
        data: {
          posts: {
            post1: {
              id: 'post1',
              metadata: {
                reactions: [{ user_id: 'abcd', emoji_name: '+1' }],
              },
            },
            post2: {
              id: 'post2',

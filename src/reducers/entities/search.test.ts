...
import { PostTypes, SearchTypes, UserTypes } from 'action-types'
...
describe('reducers.entities.search', () => {
  describe('results', () => {
    it('initial state', () => {
      ...
      const actualState = reducer({ results: inputState } as any, action)
  ...
  describe('fileResults', () => {
    it('initial state', () => {
      ...
      const actualState = reducer({ fileResults: inputState } as any, action)
  ...
  describe('matches', () => {
    it('initial state', () => {
      ...
      const actualState = reducer({ matches: inputState } as any, action as any)
    ...
    describe('SearchTypes.RECEIVED_SEARCH_POSTS', () => {
      it('no matches received', () => {
        ...
        const actualState = reducer({ matches: inputState } as any, action)
        assert.deepEqual(actualState.matches, expectedState)
      })
  ...
  describe('pinned', () => {
    it('do not show multiples of the same post', () => {
      ...
      const actualState = reducer({ pinned: inputState } as any, action)

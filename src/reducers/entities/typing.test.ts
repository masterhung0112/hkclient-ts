...
describe('Reducers.Typing', () => {
  it('initial state', async () => {
    ...
    state = typingReducer(state, {} as any)
  ...
  it('WebsocketEvents.STOP_TYPING', async () => {
    ...
    assert.deepEqual(state, {}, 'deleting second user from second channel')
    ...
    assert.deepEqual(state, {}, 'should delete when the timestamp is newer')
  })
})

...
describe('Selectors.Channels.getMyChannels', () => {
  ...
  it('get my channels in current team and DMs', () => {
    const channelsInCurrentTeam: any = [channel1, channel3].sort(sortChannelsByDisplayName.bind(null, []))
...
describe('Selectors.Channels.getOtherChannels', () => {
  ...
  it('get public channels not member of', () => {
    assert.deepEqual(
      Selectors.getOtherChannels(testState),
      [channel1, channel5].sort(sortChannelsByDisplayName.bind(null, []))
    )
  })
      ...
      entities: {
        ...
        channels: {
          ...
          channelsInTeam: {
            ...
            [team2.id]: [...testState.entities.channels.channelsInTeam[team2.id], newChannel.id],
          },
        },
      },
    }
    ...
    const modifiedState = {
      ...
      entities: {
        ...
        channels: {
          ...
          channelsInTeam: {
            ...testState.entities.channels.channelsInTeam,
            [team2.id]: [...testState.entities.channels.channelsInTeam[team2.id], anotherChannel.id],
          },
        },
      },
    }
...
describe('Selectors.Channels.getUnreadsInCurrentTeam', () => {
  ...
  it('get unreads for current read channel', () => {
    const testState2 = {
      ...testState,
      entities: { ...testState.entities, channels: { ...testState.entities.channels, currentChannelId: channel3.id } },
    }
  ...
  it('get unreads for channel not on members', () => {
    const testState2 = {
      ...
      entities: {
        ...testState.entities,
        channels: { ...testState.entities.channels, currentChannelId: 'some_other_id' },
      },
    }
    assert.equal(Selectors.countCurrentChannelUnreadMessages(testState2), 0)
  })

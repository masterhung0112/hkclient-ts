...
function sortChannelsByRecencyOrAlpha(
  locale: string,
...
export const mapAndSortChannelIds = (
  ...
  return sortMentionsFirst
    ? hasMentionedChannelIds.concat(mutedChannelIds, otherChannelIds)
    : otherChannelIds.concat(mutedChannelIds)
}
...
export function isChannelReadOnly(state: GlobalState, channel: Channel): boolean {
  return (
    ...
    getConfig(state).ExperimentalTownSquareIsReadOnly === 'true'
  )
}
...
export function shouldHideDefaultChannel(state: GlobalState, channel: Channel): boolean {
  return (
    ...
    channel.name === General.DEFAULT_CHANNEL &&
    !isCurrentUserSystemAdmin(state) &&
    getConfig(state).ExperimentalHideTownSquareinLHS === 'true'
  )
}
...
export const getAllDirectChannelsNameMapInCurrentTeam: (
  state: GlobalState
) => NameMappedObjects<Channel> = createSelector(
  getAllChannels,
  getDirectChannelsSet,
...
export const getDefaultChannel: (state: GlobalState) => Channel | undefined | null = createSelector(
  ...
  (channels: IDMappedObjects<Channel>, teamId: string): Channel | undefined | null => {
    return Object.keys(channels)
      ...
      .find((c) => c && c.team_id === teamId && c.name === General.DEFAULT_CHANNEL)
  }
)

export const getMembersInCurrentChannel: (
  state: GlobalState
) => UserIDMappedObjects<ChannelMembership> = createSelector(
  getCurrentChannelId,
  getChannelMembersInChannels,
  (
    currentChannelId: string,
    members: RelationOneToOne<Channel, UserIDMappedObjects<ChannelMembership>>
  ): UserIDMappedObjects<ChannelMembership> => {
    return members[currentChannelId]
  }
)

export const getUnreads: (
  state: GlobalState
) => {
  messageCount: number
  mentionCount: number
  ...
  (
    ...
    myTeams: Team[],
    myTeamMemberships: RelationOneToOne<Team, TeamMembership>
  ): {
    messageCount: number
    mentionCount: number
  } => {
    ...
    const otherTeamsUnreadCountForChannels = myTeams.reduce(
      (acc, team) => {
...
export const getUnreadsInCurrentTeam: (
  a: GlobalState
) => {
  messageCount: number
  mentionCount: number
...
export const canManageChannelMembers: (state: GlobalState) => boolean = createSelector(
  ...
  (state: GlobalState): boolean =>
    haveICurrentChannelPermission(state, {
...
export const getUnreadChannelIds: (
  state: GlobalState,
  lastUnreadChannel?: Channel | null
) => string[] = createIdsSelector(
  getAllChannels,
  getMyChannelMemberships,
...
export const getMapAndSortedUnreadChannelIds: (
  state: GlobalState,
  lastUnreadChannel: Channel,
  sorting: SortingType
) => string[] = createIdsSelector(
  getUnreadChannels,
  getCurrentUser,
...
export const getSortedUnreadChannelIds: (
  state: GlobalState,
  lastUnreadChannel: Channel | null,
  unreadsAtTop: boolean,
  favoritesAtTop: boolean,
...
export const getAllRecentChannels: (state: GlobalState) => Channel[] = createSelector(
  ...
  (
    ...
    const locale = currentUser.locale || General.DEFAULT_LOCALE
    const recentChannels = Channels.sort(sortChannelsByRecencyOrAlpha.bind(null, locale, lastPosts, sorting))
...
export const getFavoriteChannels: (state: GlobalState) => Channel[] = createIdsSelector(
  ...
  (
    ...
    const favoriteChannel = favoriteIds
      .filter((id) => {
        ...
        if (
          channel.type === General.DM_CHANNEL &&
          !isDirectChannelVisible(
            profiles[otherUserId] || otherUserId,
            config,
            prefs,
            channel,
            null,
...
export const getFavoriteChannelIds: (
  state: GlobalState,
  lastUnreadChannel: Channel,
  unreadsAtTop: boolean,
  favoritesAtTop: boolean,
...
export const getSortedFavoriteChannelIds: (
  ...
  (
    ...
    favoritesAtTop: boolean,
    sorting: SortingType
  ) => getFavoriteChannelIds(state, lastUnreadChannel, unreadsAtTop, favoritesAtTop, sorting),
...
export const getPublicChannels: (state: GlobalState) => Channel[] = createSelector(
  ...
  (currentUser, channels, myMembers, teamChannelIds) => {
    ...
    const publicChannels = teamChannelIds
      .filter((id) => {
        if (!myMembers[id]) {
          return false
        }
...
export const getPublicChannelIds: (
  state: GlobalState,
  lastUnreadChannel: Channel,
  unreadsAtTop: boolean,
  favoritesAtTop: boolean,
...
export const getSortedPublicChannelIds: (
  state: GlobalState,
  lastUnreadChannel: Channel | null,
  unreadsAtTop: boolean,
  favoritesAtTop: boolean,
  ...
  (
    ...
    favoritesAtTop: boolean,
    sorting: SortingType = 'alpha'
  ) => getPublicChannelIds(state, lastUnreadChannel, unreadsAtTop, favoritesAtTop, sorting),
  (state, lastUnreadChannel, unreadsAtTop = true) => unreadsAtTop,
...
export const getPrivateChannels: (a: GlobalState) => Channel[] = createSelector(
  ...
  (currentUser, channels, myMembers, teamChannelIds) => {
    ...
    const privateChannels = teamChannelIds
      .filter((id) => {
        if (!myMembers[id]) {
          return false
        }
...
export const getSortedPrivateChannelIds: (
  state: GlobalState,
  lastUnreadChannel: Channel | null,
  unreadsAtTop: boolean,
  favoritesAtTop: boolean,
  ...
  (
    ...
    favoritesAtTop: boolean,
    sorting: SortingType = 'alpha'
  ) => getPrivateChannelIds(state, lastUnreadChannel, unreadsAtTop, favoritesAtTop, sorting),
  (state, lastUnreadChannel, unreadsAtTop = true) => unreadsAtTop,
  (state, lastUnreadChannel, unreadsAtTop, favoritesAtTop = true) => favoritesAtTop,
  filterChannels
)
...
export const getDirectChannelIds: (
  state: GlobalState,
  lastUnreadChannel: Channel,
  unreadsAtTop: boolean,
  favoritesAtTop: boolean,
...
export const getSortedDirectChannelIds: (
  ...
  favoritesAtTop: boolean,
  sorting: SortingType
) => Array<$ID<Channel>> = createIdsSelector(
  getUnreadChannelIds,
  getFavoritesPreferences,
  (
    state: GlobalState,
    ...
    favoritesAtTop: boolean,
    sorting: SortingType = 'alpha'
  ) => getDirectChannelIds(state, lastUnreadChannel, unreadsAtTop, favoritesAtTop, sorting),
  (state, lastUnreadChannel, unreadsAtTop = true) => unreadsAtTop,
  (state, lastUnreadChannel, unreadsAtTop, favoritesAtTop = true) => favoritesAtTop,
...
export const getChannelsWithUserProfiles: (
  state: GlobalState
) => Array<
  {
...
> = createSelector(
  ...
  getCurrentUserId,
  (
    channelUserMap: RelationOneToMany<Channel, UserProfile>,
    users: IDMappedObjects<UserProfile>,
    channels: Channel[],
    currentUserId: string
  ) => {
...
export const getAllSortedChannelIds: (
  ...
  (
    ...
    favoritesAtTop: boolean,
    sorting: SortingType = 'alpha'
  ) => getAllChannelIds(state, lastUnreadChannel, unreadsAtTop, favoritesAtTop, sorting),
  (state, lastUnreadChannel, unreadsAtTop = true) => unreadsAtTop,
  (state, lastUnreadChannel, unreadsAtTop, favoritesAtTop = true) => favoritesAtTop,
  filterChannels
)

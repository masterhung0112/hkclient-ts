...
describe('Selectors.Posts', () => {
  ...
  it('should return single post with no children', () => {
    ...
    assert.deepEqual(getPostsForThread(testState, { channelId: '2', rootId: 'f' } as any), [posts.f])
  })

  it('should return post with children', () => {
    const getPostsForThread = Selectors.makeGetPostsForThread()

    assert.deepEqual(getPostsForThread(testState, { channelId: '1', rootId: 'a' } as any), [posts.e, posts.c, posts.a])
  })
  ...
  it('should return profiles for reactions', () => {
    ...
    assert.deepEqual(getProfilesForReactions(testState, [reaction1] as any), [user1])
  })
  ...
  it('get posts in channel with notify comments as any', () => {
    ...
    userAny.notify_props = { comments: 'any' } as any
    const profilesAny = {}
    ...
    const testStateAny = deepFreezeAndThrowOnMutation({
      entities: {
        ...
        posts: {
          posts: postsAny,
          postsInChannel: {
            1: [{ order: ['f', 'e', 'd', 'c', 'b', 'a'], recent: true }],
  ...
  it('get posts in channel with notify comments as root', () => {
    ...
    userRoot.notify_props = { comments: 'root' } as any
    const profilesRoot = {}
  ...
  it('get posts in channel with notify comments as never', () => {
    ...
    userNever.notify_props = { comments: 'never' } as any
    const profilesNever = {}
  ...
  describe('getPostIdsAroundPost', () => {
    ...
    it('posts around', () => {
      ...
      const state: any = {
        entities: {
          posts: {
            postsInChannel: {
              1234: [{ order: ['a', 'b', 'c', 'd', 'e'], recent: true }],
            },
          },
        },
      }
    ...
    it('posts before limit', () => {
      ...
      assert.deepEqual(getPostIdsAroundPost(state, 'a', '1234', { postsBeforeCount: 2 } as any), ['a', 'b', 'c'])
    })
    ...
    it('posts before/after limit', () => {
      ...
      const state: any = {
        entities: {
          posts: {
            postsInChannel: {
              1234: [{ order: ['a', 'b', 'c', 'd', 'e', 'f'], recent: true }],
            },
          },
        },
      }

      assert.deepEqual(getPostIdsAroundPost(state, 'c', '1234', { postsBeforeCount: 2, postsAfterCount: 1 }), [
        'b',
        'c',
        'd',
        'e',
        ...
        entities: {
          ...
          posts: {
            ...
            postsInChannel: {
              ...
              abcd: [{ order: ['g', 'h', 'i', 'j', 'k', 'l'], recent: true }],
            },
          },
        },
      }
      ...
      state = {
        ...
        entities: {
          ...
          posts: {
            ...
            postsInChannel: {
              ...state.entities.posts.postsInChannel,
              abcd: [{ order: ['y', 'g', 'h', 'i', 'j', 'k', 'l', 'f', 'z'], recent: true }],
            },
          },
        },
      }
      ...
      state = {
        ...
        entities: {
          ...
          posts: {
            ...
            postsInChannel: {
              ...state.entities.posts.postsInChannel,
              abcd: [{ order: ['y', 'g', 'i', 'h', 'j', 'l', 'k', 'z'], recent: true }],
            },
          },
        },
      }
    ...
    it('Should return null as recent chunk does not exists', () => {
      const state: any = {
        entities: {
          posts: {
            postsInChannel: {
              1234: [{ order: ['a', 'b', 'c', 'd', 'e', 'f'], recent: false }],
            },
          },
        },
      }
    ...
    it('Should return as oldest chunk exists', () => {
      const state: any = {
        entities: {
          posts: {
            postsInChannel: {
              1234: [{ order: ['a', 'b', 'c', 'd', 'e', 'f'], oldest: true, recent: true }],
            },
          },
        },
      }
    ...
    it('Should return null as recent chunk does not exists', () => {
      const state: any = {
        entities: {
          posts: {
            postsInChannel: {
              1234: [{ order: ['a', 'b', 'c', 'd', 'e', 'f'], recent: false, oldest: false }],
            },
          },
        },
      }
      ...
      const state: any = {
        entities: {
          posts: {
            ...
            postsInChannel: {
              1234: [{ order: ['a', 'b', 'c'], recent: true, oldest: true }],
            },
          },
        },
      }
      ...
      const state: any = {
        entities: {
          posts: {
            posts: testPosts,
            postsInChannel: {
              channelId: [{ order: ['1000', '1001', '1002', '1003'], recent: true }],
            },
          },
          preferences: {
            myPreferences: {
      ...
      const state: any = {
        entities: {
          ...
          posts: {
            posts: postsAny,
            postsInChannel: {
              abcd: [{ order: ['b', 'c', 'd', 'e'], recent: true }],
            },
          },
          preferences: {
            myPreferences: {},
    ...
    const state: any = {
      entities: {
        ...
        posts: {
          posts: postsAny,
          postsInChannel: {
            abcd: [{ order: ['b', 'c', 'd', 'e', 'f'], recent: true }],
          },
          postsInThread: {},
        },
        preferences: {

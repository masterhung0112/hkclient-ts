...
describe('Selectors.Preferences', () => {
  ...
  describe('get theme', () => {
    ...
    it('custom theme', () => {
      const currentTeamId = '1234'
      const theme: any = { sidebarBg: '#ff0000' }
    ...
    it('mentionBj backwards compatability theme', () => {
      const currentTeamId = '1234'
      const theme: any = { mentionBj: '#ff0000' }
    ...
    it('updates sideBarTeamBarBg variable when its not present', () => {
      const currentTeamId = '1234'
      const theme: any = { sidebarHeaderBg: '#ff0000' }
      ...
      assert.deepEqual(
        ...
        } as any).sidebarTeamBarBg,
        ThemeUtils.blendColors(theme.sidebarHeaderBg, '#000000', 0.2, true)
      )
    })
  ...
  test('should return value from the preference if set', () => {
    const state = {
      entities: {
        ...
        preferences: {
          myPreferences: {
            [getPreferenceKey(Preferences.CATEGORY_SIDEBAR_SETTINGS, Preferences.SHOW_UNREAD_SECTION)]: {
              value: 'true',
            },
          },
        },
      ...
      entities: {
        ...
        preferences: {
          myPreferences: {
            ...
            [getPreferenceKey(Preferences.CATEGORY_SIDEBAR_SETTINGS, '')]: {

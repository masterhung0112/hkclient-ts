...
} = createSelector(getMySystemRoles, getMyTeamRoles, getMyChannelRoles, (systemRoles, teamRoles, channelRoles) => {
  return {
    system: systemRoles,
    team: teamRoles,
...
export const getRolesById: (state: GlobalState) => Dictionary<Role> = createSelector(getRoles, (rolesByName) => {
...
export const haveICurrentChannelPermission: (
  state: GlobalState,

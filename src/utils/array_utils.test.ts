...
describe('insertMultipleWithoutDuplicates', () => {
  test('should add the item at the given location', () => {
    expect(insertMultipleWithoutDuplicates(['a', 'b', 'c', 'd'], ['z', 'y', 'x'], 0)).toEqual([
      'z',
      'y',
      'x',
      'a',
    ...
    expect(insertMultipleWithoutDuplicates(['a', 'b', 'c', 'd'], ['z', 'y', 'x'], 1)).toEqual([
      'a',
      'z',
      'y',
      'x',
    ...
    expect(insertMultipleWithoutDuplicates(['a', 'b', 'c', 'd'], ['z', 'y', 'x'], 2)).toEqual([
      'a',
      'b',
      'z',
      'y',
    ...
    expect(insertMultipleWithoutDuplicates(['a', 'b', 'c', 'd'], ['z', 'y', 'x'], 3)).toEqual([
      'a',
      'b',
      'c',
      'z',
    ...
    expect(insertMultipleWithoutDuplicates(['a', 'b', 'c', 'd'], ['z', 'y', 'x'], 4)).toEqual([
      'a',
      'b',
      'c',
      'd',
  ...
  test('should properly place new and existing items', () => {
    expect(insertMultipleWithoutDuplicates(['a', 'b', 'c', 'd'], ['z', 'y', 'x', 'a', 'c'], 0)).toEqual([
      'z',
      'y',
      'x',
      'a',
    ...
    expect(insertMultipleWithoutDuplicates(['a', 'b', 'c', 'd'], ['z', 'y', 'x', 'a', 'c'], 1)).toEqual([
      'b',
      'z',
      'y',
      'x',
    ...
    expect(insertMultipleWithoutDuplicates(['a', 'b', 'c', 'd'], ['z', 'y', 'x', 'a', 'c'], 2)).toEqual([
      'b',
      'd',
      'z',
      'y',
  ...
  test('should handle invalid index inputs', () => {
    expect(insertMultipleWithoutDuplicates(['a', 'b', 'c', 'd'], ['e', 'f'], 10)).toStrictEqual([
      'a',
      'b',
      'c',
      'd',
    ...
    expect(insertMultipleWithoutDuplicates(['a', 'b', 'c', 'd'], ['e', 'f'], -2)).toStrictEqual([
      'a',
      'b',
      'e',
      'f',

...
describe('PostUtils', () => {
  describe('shouldFilterJoinLeavePost', () => {
    it('show join/leave posts', () => {
      ...
      assert.equal(shouldFilterJoinLeavePost({ type: '' } as any, showJoinLeave), false)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.CHANNEL_DELETED } as any, showJoinLeave), false)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.DISPLAYNAME_CHANGE } as any, showJoinLeave), false)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.CONVERT_CHANNEL } as any, showJoinLeave), false)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.EPHEMERAL } as any, showJoinLeave), false)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.HEADER_CHANGE } as any, showJoinLeave), false)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.PURPOSE_CHANGE } as any, showJoinLeave), false)

      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.JOIN_LEAVE } as any, showJoinLeave), false)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.JOIN_CHANNEL } as any, showJoinLeave), false)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.LEAVE_CHANNEL } as any, showJoinLeave), false)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.ADD_REMOVE } as any, showJoinLeave), false)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.ADD_TO_CHANNEL } as any, showJoinLeave), false)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.REMOVE_FROM_CHANNEL } as any, showJoinLeave), false)

      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.JOIN_TEAM } as any, showJoinLeave), false)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.LEAVE_TEAM } as any, showJoinLeave), false)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.ADD_TO_TEAM } as any, showJoinLeave), false)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.REMOVE_FROM_TEAM } as any, showJoinLeave), false)
    })
    ...
    it('hide join/leave posts', () => {
      ...
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.JOIN_LEAVE } as any, showJoinLeave), true)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.JOIN_CHANNEL } as any, showJoinLeave), true)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.LEAVE_CHANNEL } as any, showJoinLeave), true)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.ADD_REMOVE } as any, showJoinLeave), true)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.ADD_TO_CHANNEL } as any, showJoinLeave), true)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.REMOVE_FROM_CHANNEL } as any, showJoinLeave), true)

      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.JOIN_TEAM } as any, showJoinLeave), true)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.LEAVE_TEAM } as any, showJoinLeave), true)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.ADD_TO_TEAM } as any, showJoinLeave), true)
      assert.equal(shouldFilterJoinLeavePost({ type: PostTypes.REMOVE_FROM_TEAM } as any, showJoinLeave), true)
    })
    ...
    it('always join/leave posts for the current user', () => {
      ...
      assert.equal(
        shouldFilterJoinLeavePost(
          { type: PostTypes.JOIN_CHANNEL, props: { username } } as any,
          showJoinLeave,
          username
        ),
        false
      ...
      assert.equal(
        shouldFilterJoinLeavePost(
          { type: PostTypes.JOIN_CHANNEL, props: { username: otherUsername } } as any,
          showJoinLeave,
          username
        ),
        true
      ...
      assert.equal(
        shouldFilterJoinLeavePost(
          { type: PostTypes.LEAVE_CHANNEL, props: { username } } as any,
          showJoinLeave,
          username
        ),
        false
      ...
      assert.equal(
        shouldFilterJoinLeavePost(
          { type: PostTypes.LEAVE_CHANNEL, props: { username: otherUsername } } as any,
          showJoinLeave,
          username
        ),
        true
      ...
      assert.equal(
        shouldFilterJoinLeavePost(
          { type: PostTypes.ADD_TO_CHANNEL, props: { username, addedUsername: otherUsername } } as any,
          showJoinLeave,
          username
        ),
        false
      ...
      assert.equal(
        shouldFilterJoinLeavePost(
          { type: PostTypes.ADD_TO_CHANNEL, props: { username: otherUsername, addedUsername: username } } as any,
          showJoinLeave,
          username
        ),
        false
      ...
      assert.equal(
        shouldFilterJoinLeavePost(
          { type: PostTypes.ADD_TO_CHANNEL, props: { username: otherUsername, addedUsername: otherUsername } } as any,
          showJoinLeave,
          username
        ),
        true
      ...
      assert.equal(
        shouldFilterJoinLeavePost(
          { type: PostTypes.REMOVE_FROM_CHANNEL, props: { removedUsername: username } } as any,
          showJoinLeave,
          username
        ),
        false
      ...
      assert.equal(
        shouldFilterJoinLeavePost(
          { type: PostTypes.REMOVE_FROM_CHANNEL, props: { removedUsername: otherUsername } } as any,
          showJoinLeave,
          username
        ),
        true
      ...
      assert.equal(
        shouldFilterJoinLeavePost({ type: PostTypes.JOIN_TEAM, props: { username } } as any, showJoinLeave, username),
        false
      )
      assert.equal(
        shouldFilterJoinLeavePost(
          { type: PostTypes.JOIN_TEAM, props: { username: otherUsername } } as any,
          showJoinLeave,
          username
        ),
        true
      ...
      assert.equal(
        shouldFilterJoinLeavePost({ type: PostTypes.LEAVE_TEAM, props: { username } } as any, showJoinLeave, username),
        false
      )
      assert.equal(
        shouldFilterJoinLeavePost(
          { type: PostTypes.LEAVE_TEAM, props: { username: otherUsername } } as any,
          showJoinLeave,
          username
        ),
        true
      ...
      assert.equal(
        shouldFilterJoinLeavePost(
          { type: PostTypes.ADD_TO_TEAM, props: { username, addedUsername: otherUsername } } as any,
          showJoinLeave,
          username
        ),
        false
      ...
      assert.equal(
        shouldFilterJoinLeavePost(
          { type: PostTypes.ADD_TO_TEAM, props: { username: otherUsername, addedUsername: username } } as any,
          showJoinLeave,
          username
        ),
        false
      ...
      assert.equal(
        shouldFilterJoinLeavePost(
          { type: PostTypes.ADD_TO_TEAM, props: { username: otherUsername, addedUsername: otherUsername } } as any,
          showJoinLeave,
          username
        ),
        true
      ...
      assert.equal(
        shouldFilterJoinLeavePost(
          { type: PostTypes.REMOVE_FROM_TEAM, props: { removedUsername: username } } as any,
          showJoinLeave,
          username
        ),
        false
      ...
      assert.equal(
        shouldFilterJoinLeavePost(
          { type: PostTypes.REMOVE_FROM_TEAM, props: { removedUsername: otherUsername } } as any,
          showJoinLeave,
          username
        ),
        true
  ...
  describe('canEditPost', () => {
    ...
    const state: any = { entities: { general: { serverVersion: '' } } }

    it('should allow to edit my post without license', () => {
      // Hasn't license
      assert.ok(
        canEditPost(state, { PostEditTimeLimit: -1 }, notLicensed, teamId, channelId, userId, {
          user_id: userId,
          type: 'normal',
        } as any)
      )
    ...
    it('should work with old permissions version', () => {
      ...
      assert.ok(
        !canEditPost(
          oldVersionState,
          { PostEditTimeLimit: null, AllowEditPost: 'never' },
          licensed,
          teamId,
          channelId,
          userId,
      ...
      assert.ok(
        canEditPost(
          oldVersionState,
          { PostEditTimeLimit: null, AllowEditPost: 'always' },
          licensed,
          teamId,
          channelId,
          userId,
      ...
      assert.ok(
        canEditPost(
          oldVersionState,
          { PostEditTimeLimit: 300, AllowEditPost: 'time_limit' },
          licensed,
          teamId,
          channelId,
          userId,
          { user_id: userId, create_at: Date.now() - 100 } as any
        )
      )
      assert.ok(
        !canEditPost(
          ...
          channelId,
          userId,
          { user_id: userId, create_at: Date.now() - 600000 } as any
        )
      )
      assert.ok(
        !canEditPost(
      ...
      assert.ok(
        !canEditPost(
          ...
          channelId,
          userId,
          { user_id: 'other', create_at: Date.now() - 100 } as any
        )
      )
      assert.ok(
        !canEditPost(
          ...
          channelId,
          userId,
          { user_id: 'other', create_at: Date.now() - 600000 } as any
        )
      )
    })

    it('should work with new permissions version', () => {
      const newVersionState: any = {
        entities: {
          general: {
            serverVersion: '4.9.0',
          },
      ...
      assert.ok(
        !canEditPost(newVersionState, { PostEditTimeLimit: -1 }, licensed, teamId, channelId, userId, {
          user_id: userId,
        } as any)
      )
      assert.ok(
        !canEditPost(newVersionState, { PostEditTimeLimit: 300 }, licensed, teamId, channelId, userId, {
          user_id: userId,
  ...
  describe('getEmbedFromMetadata', () => {
    ...
    it('should return null if embed key in argument is empty', () => {
      const embedData = getEmbedFromMetadata({ embeds: [] } as any)
      assert.equal(embedData, null)
    })

    it('should return first entry in embed key', () => {
      const embedValue = { type: 'opengraph', url: 'url' }
      const embedData = getEmbedFromMetadata({ embeds: [embedValue, { type: 'image', url: 'url1' }] } as any)
